...
public class Constants {
	...
	public static String rewardHRPerturbName = simulationDir+"BH_3Policies_50Aver_NoNoise_compareToQ_train50_05_ChooseBestQValuePrior.csv";
	public static String rewardPRQLName = simulationDir+"PRQL_3Policies_50Aver_NoNoise_compareToQ_train50_05_ChooseBestQValuePrior.csv";
	public static String rewardQLearningName = simulationDir+"QLearning_3Policies_50Aver_NoNoise_compareToQ_train50_05_ChooseBestQValuePrior.csv";
