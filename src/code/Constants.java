...
public class Constants {
	...
	public static final int NUM_EPISODES = 20000; //number of episodes agent simulates in the training task before working with the person (works with the person twice for each training task)
	public static final int NUM_EPISODES_TEST = 50; //number of episodes the agent simulates in the testing task before evaluating
	public static final int INTERVAL = 1; //when showing reward over time (Main.INPUT == Main.REWARD_OVER_ITERS), reward is only recorded at every interval (e.g. every 100 iterations)
	...
	public static int NUM_AVERAGING = 20; //run simulations this many times and average to get a more robust result
	public static int NUM_RBM_DATA_POINTS = 50;
	...
	public static String numIterName = simulationDir+"withRBMNew_20aver_withAdaPT_numIter_"+DOMAIN_NAME+".csv";
