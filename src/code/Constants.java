...
public class Constants {
	...
	public static final int NUM_EPISODES = 5000; //number of episodes agent simulates in the training task before working with the person (works with the person twice for each training task)
	...
	public static String simulationDir = "C:\\PerturbSimulationData\\07-28-2015-5\\";
