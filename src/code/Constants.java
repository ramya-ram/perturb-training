...
public class Constants {
	...
	public static String numIterName = simulationDir+"10aver_allConditions_numIter_"+DOMAIN_NAME+"_new.csv";
	public static String closestTrainingTask = simulationDir+"closestTrainingTask_"+DOMAIN_NAME+"_new.csv";
