...
public class Constants {
	...
	public static String rewardProceQName = simulationDir+"PQ_grid_changingTokensPits_800000train_3000test_30steps_BaseTaskZeroPolicy.csv";
	public static String rewardPerturbQName = simulationDir+"BQ_grid_changingTokensPits_800000train_3000test_30steps_BaseTaskZeroPolicy.csv";
	public static String rewardHRPerturbName = simulationDir+"BH_grid_changingTokensPits_800000train_3000test_30steps_BaseTaskZeroPolicy.csv";
	public static String rewardPRQLName = simulationDir+"PRQL_grid_changingTokensPits_800000train_3000test_30steps_BaseTaskZeroPolicy.csv";
