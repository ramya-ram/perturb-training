...
public class Main {
	...
	public static void main(String[] args){	
		...
		for(int i=1; i<=Constants.NUM_TRAINING_SESSIONS; i++){
			...
			MyWorld perturbWorld = new MyWorld(Constants.TRAINING, true, i, Constants.trainingGoalLocs[i-1], Constants.allTokenLocs.get(0), Constants.allPitLocs.get(0));
		...
		for(int i=1; i<=Constants.NUM_TESTING_SESSIONS; i++){
			MyWorld testWorld = new MyWorld(Constants.TESTING, true, i, Constants.testingGoalLocs[i-1], Constants.allTokenLocs.get(0), Constants.allPitLocs.get(0));
