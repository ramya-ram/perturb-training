...
public class Main {
	...
	public static void main(String[] args){
		...
		for(int i=1; i<=Constants.NUM_TRAINING_SESSIONS; i++){
			...
			MyWorld perturbWorld = new MyWorld(Constants.TRAINING, true, i, Constants.trainingGoalItems[i-1]);//, Constants.trainingGoalLocs[i-1], Constants.allTokenLocs.get(i-1), Constants.allPitLocs.get(i-1));
		...
		for(int i=1; i<=Constants.NUM_TESTING_SESSIONS; i++){
			MyWorld testWorld = new MyWorld(Constants.TESTING, true, i, Constants.testingGoalItems[i-1]);//, Constants.testingGoalLocs[i-1], Constants.allTokenLocsTest.get(i-1), Constants.allPitLocsTest.get(i-1));
