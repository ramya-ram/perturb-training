...
public class SocketTestServer extends JPanel /*JFrame*/ {
    ...
    private JTextField portField = new JTextField("256",10);
    ...
    public JTextArea messagesField = new JTextArea();
    
    private JLabel sendLabel = new JLabel("Message");
    public JTextField sendField = new JTextField();
    ...
    public JPanel trainingTextPanel;
    public JLabel trainingTextLabel;
    public JButton startRound = new JButton("Start the Round!");
    ...
    public SocketTestServer(final JFrame parent) {
        ...
        timeDisplay.setVerticalTextPosition(JLabel.CENTER);
        timeDisplay.setHorizontalTextPosition(JLabel.CENTER);
        timeDisplay.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 40));
        ...
        startRound.addActionListener(startListener);
        startRound.setEnabled(false);
        timePanel.add(startRound, BorderLayout.SOUTH);
        ...
        gbc.gridy = 1;
        //nextButton.setToolTipText("Clear conversation with client");
        //nextButton.setMnemonic('C');
        ActionListener clearListener = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                messagesField.setText("");
                nextClicked = true;
                messagesField.setText("Loading...\n");
            }
        };
        nextButton.addActionListener(clearListener);
        ...
        eastPanel.setSize(new Dimension(10, 50));
        JPanel westPanel = new JPanel();
        westPanel.setSize(new Dimension(10, 50));
        trainingTextPanel = new JPanel();
        trainingTextLabel = new JLabel();
        trainingTextLabel.setFont(new Font("Serif", Font.BOLD, 20));
        trainingTextPanel.add(trainingTextLabel);
        //trainingTextPanel.add(startRound);
        northPanel.add(westPanel);
        northPanel.add(trainingTextPanel);
